...
contract MockECDSAVerifier is ECDSAVerifier {
    constructor(address[] memory _validators, uint256 _session, address _oracle, bytes memory _equitoAddress) ECDSAVerifier(_validators, _session, _oracle, _equitoAddress) {}
